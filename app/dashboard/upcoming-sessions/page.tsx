...
export default function Page() {
    ...
    const fetchSlots = async (userId: string) => {
        ...
        const populatedSlots = res?.data.map((slot: any) => ({
            ...
            time_end: slot.time_end ? new Date(slot.time_end) : undefined,
        }));
    ...
    async function handleCancel(slot: ISlotPopulated) {
        const res = await FetchApi.patch(`/slot/${slot._id + ""}`, {
            action: "cancel",
            userId: dummyUserId,
        });
                            ...
                            >
                                <div className="button-and-dropdown relative">
                                    <button
                                        ...
                                        onClick={() =>
                                            setDropdownOpen(slot._id.toString())
                                        }
                                    >
                                        <svg
                                    ...
                                    {dropdownOpen === slot._id.toString() && (
                                ...
                                {modalSlot && (
                                    <CancelModal
                                        ...
                                        onCancel={() => handleCancel(modalSlot)}
                                    />
                                )}
